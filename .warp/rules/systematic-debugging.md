...
**When to apply:** Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes.

## Core Principle

Random fixes waste time and create new bugs. Quick patches mask underlying issues.

**CRITICAL:** ALWAYS find root cause before attempting fixes. Symptom fixes are failure.
...
3. **Check Recent Changes**
   ...
   - `git --no-pager diff`, recent commits
...
1. **Create Failing Test Case**
   ...
   - Follow TDD principles (see test-driven-development.md)
...
Remember to use correct package managers:
```bash
# Node.js tests
