...
export interface IQueryPreprocessor {
   ...
   */
  preprocess(request: UnifiedProcessingRequest): Promise<UnifiedProcessingRequest>;
}
...
export class QueryPreprocessor implements IQueryPreprocessor {
  public async preprocess(request: UnifiedProcessingRequest): Promise<UnifiedProcessingRequest> {
  ...
  private extractContext(context: UnifiedProcessingRequest['context']): UnifiedProcessingRequest['context'] {
