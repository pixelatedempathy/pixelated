...
export async function validateToken(
  ...
  try {
    ...
    // We use getProfile from auth0Authentication since UserInfoClient is not initialized
    ...
    const { email, name, picture, nickname, given_name, family_name, ...filteredUserInfo } = userInfo as any
