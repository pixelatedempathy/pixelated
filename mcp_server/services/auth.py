...
from ..utils.security import hash_password, verify_password, generate_secure_token
...
class AuthService:
    ...
    async def revoke_agent_tokens(self, agent_id: str) -> None:
        ...
        # This would require additional logic to check blacklist in validate_token
