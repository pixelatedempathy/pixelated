...
This directory contains K6 load tests for the Pixelated Empathy multimodal AI
system. The tests validate performance targets under realistic production load
conditions.
