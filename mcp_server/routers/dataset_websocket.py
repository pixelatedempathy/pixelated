...
from ..services.dataset_integration import DatasetIntegrationService, get_dataset_integration_service
...
from ..models.dataset import DatasetProcessingRequest, DatasetStatusResponse, DatasetProgressUpdate
...
class DatasetProgressUpdate(BaseModel):
    ...
    bias_score: Optional[float] = Field(None, description="Current bias score")
...
class DatasetStatisticsRequest(BaseModel):
    ...
    metric_categories: Optional[List[str]] = Field(default=None, description="Specific metric categories")
