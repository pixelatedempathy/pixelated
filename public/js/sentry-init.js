  ...
  try {
    window.Sentry.init({
      ...
      tracesSampleRate: Number(
        (window.__ENV && window.__ENV.PUBLIC_SENTRY_TRACES_SAMPLE_RATE) ??
          (location.hostname === 'localhost' ? 1.0 : 0.1),
      ),
      profilesSampleRate: Number(
        (window.__ENV && window.__ENV.PUBLIC_SENTRY_PROFILES_SAMPLE_RATE) ??
