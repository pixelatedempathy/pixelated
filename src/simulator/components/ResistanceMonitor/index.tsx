...
export function ResistanceMonitor({
    ...
    const renderMaturityBar = () => (
        <div className={styles.maturityWrap}>
            ...
            >
                <div
                    className={`${styles.maturityBarFill} ${maturityPct != null
    ...
    const renderEmotionMosaic = () => {
        ...
        return (
            <div className={styles.emotionGrid} role="group" aria-label="Plutchik emotion scores">
    ...
    const renderPrediction = () => {
        ...
        return (
            <div className={styles.predictionWrap}>
                ...
                <p
                    className={`${styles.predictionText} ${isAcute ? styles.predictionTextAcute : ''
                        }`}
                >
    ...
    const renderBreakthrough = () => {
        ...
        return (
            <div className={styles.breakthroughWrap}>
                ...
                <div
                    className={`${styles.breakthroughBarTrack} ${score > 0.7 ? styles.breakthroughHigh : ''
                        }`}
                    role="progressbar"
                    aria-valuenow={pct}
                    aria-valuemin={0}
                ...
                >
                    <div
                        className={`${styles.breakthroughBarFill} ${score > 0.7 ? styles.breakthroughHigh : ''
                            }`}
                        style={{ width: `${pct}%` }}
                    />
                </div>
