...
Use Let's Encrypt for trusted, free SSL certificates. See
[`LETSENCRYPT_SETUP.md`](LETSENCRYPT_SETUP.md:1) for detailed instructions.
...
- **Development**: Use the self-signed certificate
