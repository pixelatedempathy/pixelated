...
>>>>>>> origin/master
		...
		writer.WriteString("# Rclone SSH Sync Exclusion List\n")
		writer.WriteString("# Generated: " + time.Now().UTC().Format(time.RFC3339) + "\n")
		writer.WriteString("# Repository: " + cfg.localDir + "\n\n")
