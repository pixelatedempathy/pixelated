import {
  require_node_url
} from "./chunk-WCNL5WZ4.js";
import {
  require_abort_controller,
  require_is_stream,
  require_node,
  require_zlib
} from "./chunk-3WVS7GWC.js";
import {
  require_assert
...
import {
  ...
  require_node_path,
  require_node_stream
} from "./chunk-2EQHUXMW.js";
import {
  require_node_events
} from "./chunk-NH5TKBBJ.js";
import {
  require_path
...
// node_modules/.pnpm/async@3.2.6/node_modules/async/dist/async.mjs
var async_exports = {};
  ...
  "node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/legacy-streams.js"(exports, module) {
    ...
    function legacy(fs) {
      ...
      function ReadStream(path2, options) {
        ...
        for (var index3 = 0, length = keys.length; index3 < length; index3++) {
          var key = keys[index3];
...
var require_stream_readable = __commonJS({
  "node_modules/.pnpm/readable-stream@2.3.8/node_modules/readable-stream/lib/_stream_readable.js"(exports, module) {
    ...
    function ReadableState(options, stream2) {
      ...
      this.encoding = null;
      if (options.encoding) {
        if (!StringDecoder2) StringDecoder2 = require_string_decoder2().StringDecoder;
...
var require_utils = __commonJS({
  "node_modules/.pnpm/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/utils.js"(exports, module) {
    ...
    function isFinished(stream2, opts) {
      ...
      if ((opts === null || opts === void 0 ? void 0 : opts.writable) !== false && isWritable2(stream2)) {
        return false;
      }
      return true;
    }
...
var require_end_of_stream = __commonJS({
  "node_modules/.pnpm/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/end-of-stream.js"(exports, module) {
    ...
    function eos(stream2, options, callback) {
      ...
      } else if (!readable && (!willEmitClose || isReadable2(stream2)) && (writableFinished || isWritable2(stream2) === false)) {
        process2.nextTick(onclosed);
      } else if (!writable && (!willEmitClose || isWritable2(stream2)) && (readableFinished || isReadable2(stream2) === false)) {
        process2.nextTick(onclosed);
...
var require_destroy2 = __commonJS({
  "node_modules/.pnpm/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/destroy.js"(exports, module) {
    ...
    function errorOrDestroy(stream2, err, sync2) {
...
var require_writable = __commonJS({
  "node_modules/.pnpm/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/writable.js"(exports, module) {
    ...
    function finishMaybe(stream2, state, sync2) {
      if (needFinish(state)) {
        prefinish(stream2, state);
        if (state.pendingcb === 0) {
          if (sync2) {
...
var require_operators = __commonJS({
  "node_modules/.pnpm/readable-stream@4.7.0/node_modules/readable-stream/lib/internal/streams/operators.js"(exports, module) {
    ...
    function compose2(stream2, options) {
      ...
      if (isNodeStream(stream2) && !isWritable2(stream2)) {
      ...
      toRegExpSource(allowDot) {
        ...
        if (!this.type) {
          ...
          const src = this.#parts.map((p) => {
            const [re, _2, hasMagic2, uflag] = typeof p === "string" ? _AST.#parseGlob(p, this.#hasMagic, noEmpty) : p.toRegExpSource(allowDot);
        ...
        if (this.#size !== 0) {
          ...
          if (index3 !== void 0) {
            if (this.#autopurgeTimers?.[index3]) {
              ...
              this.#autopurgeTimers[index3] = void 0;
            }
            deleted = true;
            if (this.#size === 1) {
              this.#clear(reason);
...
var init_esm5 = __esm({
  "node_modules/.pnpm/minipass@7.1.2/node_modules/minipass/dist/esm/index.js"() {
    import_node_events = __toESM(require_node_events());
    import_node_stream = __toESM(require_node_stream());
    import_node_string_decoder = __toESM(require_node_string_decoder());
...
var init_esm6 = __esm({
  "node_modules/.pnpm/path-scurry@2.0.1/node_modules/path-scurry/dist/esm/index.js"() {
    ...
    actualFS = __toESM(require_node_fs());
    import_promises = __toESM(require_promises2());
    init_esm5();
    ...
    PathBase = class {
      ...
      #readdirPromoteChild(e, p, index3, c) {
        const v = p.name;
        p.#type = p.#type & IFMT_UNKNOWN | entToType(e);
        if (v !== e.name)
          p.name = e.name;
        if (index3 !== c.provisional) {
    ...
    PathScurryWin32 = class extends PathScurryBase {
       ...
       */
      parseRootPath(dir2) {
        return import_node_path.win32.parse(dir2).root.toUpperCase();
      }
      /**
       * @internal
       */
...
var init_pattern = __esm({
  "node_modules/.pnpm/glob@13.0.0/node_modules/glob/dist/esm/pattern.js"() {
    ...
    Pattern = class _Pattern {
      ...
      #isAbsolute;
      #followGlobstar = true;
      constructor(patternList, globList, index3, platform) {
...
var init_glob = __esm({
  "node_modules/.pnpm/glob@13.0.0/node_modules/glob/dist/esm/glob.js"() {
    init_esm3();
    import_node_url2 = __toESM(require_node_url(), 1);
    init_esm6();
    init_pattern();
    init_walker();
...
var require_file = __commonJS({
  "node_modules/.pnpm/archiver-utils@5.0.2/node_modules/archiver-utils/file.js"(exports, module) {
    ...
    var glob2 = (init_esm7(), __toCommonJS(esm_exports));
...
var require_streamx = __commonJS({
  "node_modules/.pnpm/streamx@2.23.0/node_modules/streamx/index.js"(exports, module) {
    ...
    var DESTROY_STATUS = DESTROYING | DESTROYED2 | PREDESTROYING;
    ...
    function afterDestroy(err) {
      ...
      stream2._duplexState |= DESTROYED2;
      stream2.emit("close");
    ...
    var Stream2 = class extends EventEmitter2 {
      ...
      get destroyed() {
        return (this._duplexState & DESTROYED2) !== 0;
      }
      get destroying() {
    ...
    var Readable = class _Readable extends Stream2 {
      ...
      [asyncIterator]() {
        ...
        return {
          ...
          next() {
            return new Promise(function(resolve, reject2) {
              ...
              else if ((stream2._duplexState & DESTROYED2) !== 0) ondata(null);
            });
          },
          return() {
            return destroy(null);
        ...
        function destroy(err) {
          stream2.destroy(err);
          return new Promise((resolve, reject2) => {
            if (stream2._duplexState & DESTROYED2) return resolve({ value: void 0, done: true });
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/ascii.js
var require_ascii = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/ascii.js"(exports, module) {
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/base64.js
var require_base64 = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/base64.js"(exports, module) {
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/hex.js
var require_hex = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/hex.js"(exports, module) {
    function byteLength(string) {
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/utf8.js
var require_utf8 = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/utf8.js"(exports, module) {
    function byteLength(string) {
      let length = 0;
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/utf16le.js
var require_utf16le = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/lib/utf16le.js"(exports, module) {
    function byteLength(string) {
...
// node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/browser.js
var require_browser = __commonJS({
  "node_modules/.pnpm/b4a@1.7.3/node_modules/b4a/browser.js"(exports, module) {
    ...
    function concat2(buffers, length) {
      if (length === void 0) {
...
var require_headers = __commonJS({
  "node_modules/.pnpm/tar-stream@3.1.7/node_modules/tar-stream/headers.js"(exports) {
    ...
    function clamp(index3, len, defaultValue) {
      if (typeof index3 !== "number") return defaultValue;
      index3 = ~~index3;
      if (index3 >= len) return len;
...
// node_modules/.pnpm/buffer-crc32@1.0.0/node_modules/buffer-crc32/dist/index.mjs
var dist_exports = {};
...
var CRC_TABLE, bufferCrc32, index2;
var init_dist = __esm({
  "node_modules/.pnpm/buffer-crc32@1.0.0/node_modules/buffer-crc32/dist/index.mjs"() {
    ...
    bufferCrc32 = crc32;
    index2 = getDefaultExportFromCjs(bufferCrc32);
  }
});
...
var require_json = __commonJS({
  "node_modules/.pnpm/archiver@7.0.1/node_modules/archiver/lib/plugins/json.js"(exports, module) {
    var inherits = require_util().inherits;
    var Transform = require_ours().Transform;
    var crc322 = (init_dist(), __toCommonJS(dist_exports));
    var util = require_archiver_utils();
...
export default require_archiver();
