...
export class PixelMultimodalChatPage {
  ...
  constructor(page: Page) {
    ...
    this.recordingIndicator = page.locator(
    ...
    this.streamingEnabledIndicator = page.locator(
  ...
  async enableStreaming() {
    const isEnabled = await this.streamingEnabledIndicator
      .isVisible()
      .catch(() => false)
    if (!isEnabled) {
