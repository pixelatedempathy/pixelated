...
from mcp_server.exceptions import AuthenticationError, ValidationError, ServiceUnavailableError
...
class WebSocketManager:
    ...
    async def add_connection(self, socket: Any, user_id: Optional[str] = None, auth_token: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None) -> bool:
    ...
    async def subscribe_to_event(self, sid: str, event_name: str, filters: Optional[Dict[str, Any]] = None) -> bool:
        if sid not in self.connections:
            return False
    ...
    async def publish_event(self, room: str, event_name: str, data: Dict[str, Any], exclude_sid: Optional[str] = None) -> None:
