import { require_react_dom } from "./chunk-Z77PBXP5.js";
import { require_react } from "./chunk-GRRGXOOZ.js";
...
var require_react_dom_client_production = __commonJS({
  "node_modules/.pnpm/react-dom@19.2.3_react@19.2.3/node_modules/react-dom/cjs/react-dom-client.production.js"(
    ...
    function propagateParentContextChanges(
      ...
      current = null;
      for (
        var parent = workInProgress2, isInsidePropagationBailout = false;
        null !== parent;
      ) {
              ...
              switch (update.tag) {
                ...
                case 3:
                  workInProgress2.flags =
                    (workInProgress2.flags & -65537) | 128;
                case 0:
                  workInProgress2 = update.payload;
                  updateLane =
    ...
    function updateClassComponent(
      ...
      if (null === workInProgress2.stateNode) {
        ...
        contextType$jscomp$0 =
          ...
          "function" === typeof context.getSnapshotBeforeUpdate;
        unresolvedOldProps =
          workInProgress2.pendingProps !== unresolvedOldProps;
        contextType$jscomp$0 ||
    ...
    function updateSuspenseComponent(current, workInProgress2, renderLanes2) {
      ...
      JSCompiler_temp &&
        ((showFallback = true), (workInProgress2.flags &= -129));
    ...
    function updateSuspenseListComponent(
      ...
      if (
        ...
        a: for (current = workInProgress2.child; null !== current; ) {
          ...
          if (current === workInProgress2) break;
    ...
    function preloadResourceAndSuspendIfNeeded(workInProgress2, resource) {
      if ("stylesheet" !== resource.type || 0 !== (resource.state.loading & 4))
        ...
        ((workInProgress2.flags |= 16777216), !preloadResource(resource))
      )
          ...
          if (null !== current && null != workInProgress2.stateNode)
            ...
            if (popHydrationState(workInProgress2))
              ...
              a: for (
                ...
                if (ownerDocument === workInProgress2) break;
            ...
            if (0 !== JSCompiler_inline_result) {
              ...
              a: {
                ...
                var wasRootDehydrated =
                  root2.current.memoizedState.isDehydrated;
                wasRootDehydrated &&
                  (prepareFreshStack(root2, JSCompiler_inline_result).flags |=
                    256);
    ...
    for (
      i$jscomp$inline_1577 = 0;
      i$jscomp$inline_1577 < simpleEventPluginEvents.length;
      i$jscomp$inline_1577++
    ) {
      ((eventName$jscomp$inline_1578 =
    ...
    function preloadModule(href, options2) {
      ...
      if (ownerDocument && href) {
        var as =
            options2 && "string" === typeof options2.as
              ? options2.as
              : "script",
          preloadSelector =
