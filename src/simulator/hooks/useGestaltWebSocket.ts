...
function validatePayload(raw: unknown): GestaltUpdatePayload | null {
  ...
  const validCrisisLevels: CrisisLevel[] = ['none', 'elevated', 'high', 'acute']
  ...
  return {
    ...
    behavioral_prediction:
      typeof r['behavioral_prediction'] === 'string'
        ...
        : '',
    persona_directive:
      typeof r['persona_directive'] === 'string' ? r['persona_directive'] : '',
