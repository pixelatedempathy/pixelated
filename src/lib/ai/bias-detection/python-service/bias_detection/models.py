...
class BiasAnalysisRequest(BaseModel):
    ...
    content_type: str = Field(
        default="text",
        description="Type of content: text, email, document, etc."
    )
    language: str = Field(
        default="en",
    ...
    include_counterfactuals: bool = Field(
        default=True,
        description="Whether to include counterfactual scenarios"
    )
...
class CounterfactualScenario(BaseModel):
    ...
    impact_assessment: str = Field(
        description="Assessment of the impact of the change"
    )
...
class BiasAnalysisResponse(BaseModel):
    ...
    bias_scores: List[BiasScore] = Field(
    ...
    keyword_analysis: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Keyword-based analysis results"
    )
    contextual_analysis: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Contextual analysis results"
    )
    
    # Recommendations and insights
    recommendations: List[Recommendation] = Field(
        default_factory=list,
        description="Bias mitigation recommendations"
    )
