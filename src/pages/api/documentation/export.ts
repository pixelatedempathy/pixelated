...
const aiService = {
  ...
  getModelInfo: () => { throw new Error('Not implemented'); },
  createChatCompletion: () => { throw new Error('Not implemented'); },
  createStreamingChatCompletion: () => { throw new Error('Not implemented'); },
  dispose: () => {},
};
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    const sessionId = url.searchParams.get('session') || url.searchParams.get('section');
    ...
    if (format === 'json') {
      ...
      body = `# Session Documentation\n\n` +
        ...
        (documentation.endTime ? `**End Time:** ${documentation.endTime}\n\n` : '') +
        `**Notes:**\n${documentation.notes}\n\n` +
