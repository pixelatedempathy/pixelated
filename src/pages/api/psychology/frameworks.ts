...
const THERAPEUTIC_FRAMEWORKS: TherapeuticFramework[] = [
  {
    ...
    category: 'cognitive',
    description:
      'Evidence-based approach focusing on the relationship between thoughts, feelings, and behaviors',
    ...
    keyTechniques: [
      {
        name: 'Thought Record',
        description:
          'Systematic identification and examination of automatic thoughts',
        implementation:
          'Client records situations, emotions, thoughts, and evidence',
      ...
      },
      {
        ...
        implementation:
          'Examine evidence for/against thoughts, develop balanced alternatives',
    ...
    evidenceBase: {
      ...
      researchSummary:
        'Over 500 RCTs demonstrate efficacy across multiple conditions. Gold standard treatment for many mental health conditions.',
  ...
  },
  {
    ...
    category: 'behavioral',
    description:
      'Comprehensive treatment combining CBT with mindfulness and distress tolerance skills',
    foundationalPrinciples: [
    ...
    evidenceBase: {
      ...
      researchSummary:
        'Extensive research demonstrating effectiveness for BPD and emotion dysregulation. Reduces self-harm and hospitalization.',
    ...
    contraindications: [
      'Unwillingness to commit to treatment',
  ...
  },
  {
    ...
    category: 'behavioral',
    description:
      'Third-wave therapy focusing on psychological flexibility and values-based living',
    foundationalPrinciples: [
    ...
    keyTechniques: [
      ...
      },
      {
        ...
        implementation:
          'Goal setting, behavioral activation aligned with values',
    ...
    evidenceBase: {
      ...
      researchSummary:
        'Growing evidence base with over 200 RCTs. Particularly effective for chronic conditions and life transitions.',
    ...
    culturalConsiderations: [
      'Collectivist values integration',
      'Religious/spiritual compatibility',
      'Language metaphors',
      'Cultural concepts of acceptance',
    ],
    integration: {
      combinesWith: [
        'Mindfulness-based interventions',
  ...
  },
  {
    ...
    description:
      'Insight-oriented therapy exploring unconscious processes and past experiences',
    foundationalPrinciples: [
    ...
    evidenceBase: {
      ...
      researchSummary:
        'Solid evidence base for depression and personality disorders. Long-term benefits demonstrated in multiple studies.',
    ...
    clientPopulations: [
      ...
      'Adolescents',
      'Individual therapy',
      'Long-term treatment candidates',
    ],
    sessionStructure: {
      typicalLength: '45-50 minutes',
    ...
    culturalConsiderations: [
      'Western individualistic framework',
      'Family dynamics',
  ...
  },
  {
    ...
    category: 'humanistic',
    description:
      'Client-centered approach emphasizing empathy, genuineness, and unconditional positive regard',
    foundationalPrinciples: [
    ...
    evidenceBase: {
      ...
      researchSummary:
        'Strong evidence for therapeutic relationship factors. Effective for various conditions when core conditions present.',
      effectivenessRating: 6,
    },
    clientPopulations: [
      'Adults',
    ...
    contraindications: [
      'Severe mental illness requiring structure',
      'Crisis situations',
      'Clients needing specific skill training',
    ],
    culturalConsiderations: [
...
function filterFrameworks(
    ...
    filtered = filtered.filter((framework) =>
      searchTerms.every(
        (term) =>
          ...
          framework.foundationalPrinciples.some((principle) =>
            principle.toLowerCase().includes(term),
          ),
      ),
    )
  }
  ...
  if (evidenceLevel && evidenceLevel !== 'all') {
    filtered = filtered.filter(
      (framework) => framework.evidenceBase.level === evidenceLevel,
    )
  }
