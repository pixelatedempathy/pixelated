...
export function useEQMetrics() {
  ...
  const getAverageMetrics = useCallback((): EQScores | null => {
    ...
    const sum = history.reduce(
      (acc, scores) => ({
        emotional_awareness:
          acc.emotional_awareness + scores.emotional_awareness,
        empathy_recognition:
          acc.empathy_recognition + scores.empathy_recognition,
        emotional_regulation:
          acc.emotional_regulation + scores.emotional_regulation,
        social_cognition: acc.social_cognition + scores.social_cognition,
        interpersonal_skills:
          acc.interpersonal_skills + scores.interpersonal_skills,
