...
describe('ProgressBar', () => {
  ...
  it('renders progress bar without label', () => {
    ...
    expect(
      screen.getByRole('progressbar', { name: 'Progress Bar' }),
    ).toBeInTheDocument()
  ...
  it('forwards aria-labelledby prop correctly', () => {
    ...
    expect(
      screen.getByRole('progressbar', { name: 'External Label' }),
    ).toBeInTheDocument()
    const progressBar = screen.getByRole('progressbar')
  ...
  it('prioritizes aria-labelledby over aria-label and label props', () => {
    ...
    expect(
      screen.getByRole('progressbar', { name: 'Priority Label' }),
    ).toBeInTheDocument()
    const progressBar = screen.getByRole('progressbar')
  ...
  it('prioritizes aria-label over label prop', () => {
    ...
    expect(
      screen.getByRole('progressbar', { name: 'Aria Label' }),
    ).toBeInTheDocument()
    const progressBar = screen.getByRole('progressbar')
