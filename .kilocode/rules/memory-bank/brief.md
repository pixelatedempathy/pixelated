...
- **Primary Dataset**: [`data/therapeutic_dataset_example.json`](../../../data/therapeutic_dataset_example.json) - 10-sample therapeutic dataset with demographics
- **Dataset Structure**: Age, gender, ethnicity, diagnosis, symptom severity, treatment outcomes
...
- **Location**: [`ai/lightning_training_package/`](../../../ai/lightning_training_package/) - Complete Lightning.ai training setup
- **Training Dataset**: ULTIMATE_FINAL_DATASET.jsonl (2.49GB, 608,497 conversations)
- **Training Components**: KAN-28 integration with 6 specialized components
