...
if (!JIRA_API_TOKEN) {
  ...
  console.error(
    'Please set the JIRA_API_TOKEN environment variable and try again',
  )
  process.exit(1)
}
      ...
      res.on('end', () => {
        try {
          ...
          if (res.statusCode >= 200 && res.statusCode < 300) {
            ...
            reject(
              new Error(
                `HTTP ${res.statusCode}: ${jsonData.errorMessages ? jsonData.errorMessages.join(', ') : data}`,
              ),
            )
          }
        } catch (e) {
...
const epicData = {
  fields: {
    ...
    summary:
      'Enhanced Auth0 Authentication System with Advanced Security and Usability Features',
    description: {
      version: 1,
      type: 'doc',
      content: [
...
const stories = [
  // Original migration stories
  {
    ...
    description:
      'Set up Auth0 tenant and configure for HIPAA compliance requirements.',
    points: 3,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Analyze existing user data and plan migration strategy from MongoDB to Auth0.',
    points: 5,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement scripts and processes to migrate existing users from MongoDB to Auth0.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Replace better-auth with Auth0 Node.js SDK in authentication service.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Update JWT token handling to use Auth0 tokens instead of custom implementation.',
    points: 5,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement role-based access control using Auth0 roles and permissions.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Configure and implement social authentication (Google OAuth) using Auth0.',
    points: 5,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Update authentication middleware and API protection to use Auth0 context.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Comprehensive testing of all authentication flows and security features.',
    points: 13,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Deploy Auth0 authentication to production and implement monitoring.',
    points: 8,
    tasks: [
  ...
  // New enhancement stories
  {
    ...
    description:
      'Fully migrate all authentication to the new Auth0 system to eliminate security inconsistencies and simplify maintenance.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement advanced security features including session management, device tracking, rate limiting, and brute force protection.',
    points: 13,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement self-service profile management, password history, email verification, and account recovery mechanisms.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement comprehensive analytics for user behavior, authentication funnels, and MFA adoption tracking.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement progressive profiling, intelligent MFA selection, remember device functionality, and improved error handling.',
    points: 13,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Ensure all authentication flows are accessible to users with disabilities.',
    points: 5,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement a modern, responsive design for all authentication pages with improved visual feedback.',
    points: 13,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Add progress indicators, success/error states, security status, and session information displays.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement comprehensive MFA features including TOTP, SMS, WebAuthn, and adaptive authentication.',
    points: 13,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement secure user impersonation with comprehensive audit logging and administrative capabilities.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement soft delete functionality, bulk import/export, and data retention policies.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Implement real-time user activity tracking with Auth0 Logs API and security event processing.',
    points: 8,
    tasks: [
  ...
  },
  {
    ...
    description:
      'Perform comprehensive testing of all enhanced authentication flows and security features.',
    points: 13,
    tasks: [
      'Test all authentication flows (login, registration, password reset)',
  ...
  },
  {
    ...
    description:
      'Create comprehensive documentation and training materials for the enhanced authentication system.',
    points: 5,
    tasks: [
  ...
  },
  {
    ...
    summary: 'Deployment and Monitoring',
    description:
      'Deploy enhanced authentication features to production and implement comprehensive monitoring.',
    points: 8,
    tasks: [
...
async function createIssues() {
  try {
    ...
    const epicResponse = await makeRequest(
      epicOptions,
    ...
    console.log(
      'Stories: PIX-1248 through PIX-1257 (original migration) and PIX-2001 through PIX-2015 (enhancements)',
    )
  } catch (error) {
