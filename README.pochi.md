...
## Rules from .cursor/rules/agent-context-engineering.mdc
...
---
Generated by ByteRover CLI for Cursor

## Rules from .cursor/rules/byterover-rules.mdc
...
## Rules from .cursor/rules/sonarqube_mcp_instructions.mdc
...
## Rules from .cursor/rules/uv-python-usage.mdc
