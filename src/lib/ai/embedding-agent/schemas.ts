...
export const EmbeddingRequestSchema = z.object({
  ...
  knowledgeType: KnowledgeTypeSchema.optional().transform(
    (val) => val ?? 'general',
  ),
  metadata: z
...
export type BatchEmbeddingRequestInput = z.input<
  typeof BatchEmbeddingRequestSchema
>
export type SimilaritySearchRequestInput = z.input<
