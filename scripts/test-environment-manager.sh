...
if [[ "$TARGET_PNPM_VERSION" == "10.19.0" ]]; then
    print_status "✅ Target pnpm version correctly set to 10.19.0"
else
...
print_status "  - setup_pnpm_environment() - Installs pnpm 10.19.0"
...
print_status "  - 1.2: pnpm 10.19.0 installation ✅"
