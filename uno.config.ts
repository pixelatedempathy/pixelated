  ...
  presets: [
    presetUno({
      ...
      rules: [
        ...
        [
          /^px-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'padding-left': c, 'padding-right': c }),
        ],
        [
          /^py-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'padding-top': c, 'padding-bottom': c }),
        ],
        ...
        [
          /^mx-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'margin-left': c, 'margin-right': c }),
        ],
        [
          /^my-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'margin-top': c, 'margin-bottom': c }),
        ],
        ...
        [
          /^grid-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'display': 'grid', 'grid-template-columns': c }),
        ],
        ...
        [
          /^ease-([a-zA-Z0-9-]+)$/,
          ([, c]) => ({ 'transition-timing-function': c }),
        ],
