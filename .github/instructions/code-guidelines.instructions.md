...
applyTo: '**'
description:
  'Pixelated Empathy core development principles and technology stack guidelines'
...
- **HIPAA++ Compliance**: All data handling must exceed standard HIPAA
  requirements
- **Zero-Knowledge Architecture**: Implement fully homomorphic encryption (FHE)
  with <50ms latency
...
- **Memory Optimization**: Use torch.cuda.amp, gradient checkpointing, PEFT
  methods
...
- **Files**: kebab-case for pages (`mental-health-chat.astro`), camelCase for
  utilities
...
- **Model Architecture**: Modular, configurable designs with proper memory
  management
- **Training**: Use mixed precision, gradient checkpointing, distributed
  training
