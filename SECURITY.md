...
Welcome to the fortress of Pixelated Empathy, where our code is so secure, even
Alan Turing would need multi-factor authentication to get in. If you’re here to
report a vulnerability, congratulations—you’ve found the one chink in our armor
(or so you think).
...
1. **Do NOT open a public issue.**
   - We prefer our vulnerabilities like our deepest secrets: disclosed
     privately.
2. **Email us at
   ...
   - Include:
     ...
     - Steps to reproduce (screenshots, logs, or interpretive dance videos
       welcome)
     - Potential impact
     - Your contact info (unless you prefer to remain a mysterious hero)
3. **PGP Encryption:**
   - If you’re feeling extra paranoid, request our PGP key for encrypted
     communication.

We aim to respond within **48 hours**. If we don’t, assume we’re busy patching
the Matrix or arguing about tabs vs spaces.
...
We only support the branches that matter. If you’re running code from a random
fork, may the odds be ever in your favor.
...
- **OWASP Top 10:**
  - If you find an OWASP Top 10 issue, you get a free virtual high-five (and a
    patch).
...
We maintain a Hall of Fame for security researchers who help us keep Pixelated
Empathy bulletproof. Want your name here? Find a bug, report it responsibly, and
...
- **Secrets Management:**
  - `.env` files are sacred. Secrets are never committed. If you do, expect a
...
for breakfast and sarcasm for lunch. But if you do find something, we’ll treat
you with the respect you deserve—unless you use tabs for indentation. Then all
bets are off.
