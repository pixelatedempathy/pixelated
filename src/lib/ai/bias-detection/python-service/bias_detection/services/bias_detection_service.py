...
class BiasDetectionService:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to initialize bias detection service: {str(e)}", error=str(e))
            return False
    ...
    def _get_bias_specific_recommendations(self, bias_score: BiasScore) -> List[Recommendation]:
        ...
        if bias_type == BiasType.GENDER:
            recommendations.append(Recommendation(
                ...
                examples=["Use 'they' instead of 'he/she'", "Use 'chairperson' instead of 'chairman'"]
            ))
        ...
        # Age bias recommendations
            ...
            recommendations.append(Recommendation(
                ...
                examples=["Use 'experienced' instead of 'old'", "Avoid 'digital native' assumptions"]
            ))
    ...
    def _get_general_recommendation(self) -> Recommendation:
        ...
        return Recommendation(
            ...
            implementation_difficulty="medium",
            estimated_impact="medium",
            examples=["Have diverse team members review content", "Use bias detection tools regularly"]
        )
    ...
    async def _get_cached_analysis(self, content_hash: str) -> Optional[BiasAnalysisResponse]:
    ...
    async def get_health_status(self) -> Dict[str, Any]:
        ...
        elif any(service.get("status") == "unhealthy" for service in [
