-- Migration: Add Consent Management Schema
-- Description: Adds tables and functions for HIPAA-compliant consent management
...
CREATE TABLE IF NOT EXISTS consent_options (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    consent_type_id UUID NOT NULL REFERENCES consent_types(id),
