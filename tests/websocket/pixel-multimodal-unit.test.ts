...
describe('WebSocket /ws/pixel-multimodal - Unit Tests', () => {
  ...
  describe('Connection Lifecycle', () => {
    it('should authenticate on connection', async () => {
      ...
      const session = await mockGetSession({
        url: 'ws://localhost/ws/pixel-multimodal',
      })
  ...
  describe('Message Reception & Buffering', () => {
    ...
    it('should buffer audio chunks', () => {
      ...
      const totalSize = audioBuffer.reduce(
  ...
  describe('Message Processing & Fusion', () => {
    ...
    it('should detect modality conflicts', () => {
      ...
      const hasConflict =
        Math.abs(textEmotion.valence - audioEmotion.valence) > conflictThreshold
    ...
    it('should log conflict warnings', () => {
      mockLogger.warn(
        'Modality conflict detected: text and audio emotions diverge significantly',
      )
  ...
  describe('Streaming Response', () => {
    ...
    it('should include latency metrics in stream', () => {
      ...
      expect(result.buffering_ms + result.processing_ms).toBeLessThan(
