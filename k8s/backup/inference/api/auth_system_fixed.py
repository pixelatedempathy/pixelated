#!/usr/bin/env python3
"""
Pixelated Empathy AI - Fixed API Authentication System
Task 1.1: Implement API Authentication System (Fixed Version)
...
class AuthenticationSystem:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        # Use unique database path for each instance to avoid conflicts
        if db_path is None:
            db_path = str(Path(__file__).parent / f"auth_{uuid.uuid4().hex[:8]}.db")
    ...
    def _create_default_admin(self):
        ...
        try:
            ...
            if admin_count == 0:
                # Create default admin user with unique username
                ...
                """, (
                    admin_username,
                    f"{admin_username}@pixelated-empathy.ai",
                    password_hash,
