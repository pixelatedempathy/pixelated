...
export const AdminDashboard: FC = () => {
  ...
  const [dashboardView, setDashboardView] = usePersistentState<'overview' | 'therapists' | 'institutions' | 'system' | 'compliance'>('admin_dashboard_view', 'overview')
  const [timeRange, setTimeRange] = usePersistentState<'week' | 'month' | 'quarter' | 'year'>('admin_dashboard_timerange', 'month')
  const [selectedTherapists, setSelectedTherapists] = usePersistentState<string[]>('admin_selected_therapists', [])
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Institutional Overview • {institutionMetrics.totalTherapists} therapists • {institutionMetrics.totalPatients} patients
                </p>
              </div>
...
const OverviewTab: FC<{
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{metrics.totalPatients.toLocaleString()}</p>
              </div>
              <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                <span className="text-blue-600 dark:text-blue-400">👥</span>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-2">{metrics.activePatients} active patients</p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Therapists</p>
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{metrics.totalTherapists}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white">{metrics.avgSessionsPerPatient}</p>
              </div>
              <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
                <span className="text-purple-600 dark:text-purple-400">📈</span>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-2">Per patient this {timeRange === 'week' ? 'week' : timeRange === 'month' ? 'month' : timeRange}</p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <p className="text-sm text-gray-500 mt-2">HIPAA & security compliance</p>
          </div>
        </FadeIn>
      </div>
      ...
      <SlideUp>
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 className="text-lg font-semibold mb-4">Therapist Performance Overview</h3>
          <div className="space-y-4">
            {therapists.map((therapist) => (
              <div key={therapist.id} className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <input
                  type="checkbox"
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        therapist.completionRate >= 95 ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200' :
                        therapist.completionRate >= 90 ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200' :
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-medium text-red-600">{therapist.riskLevelDistribution.high + therapist.riskLevelDistribution.critical}</span>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Success Rate:</span>
                      <span className="ml-2 font-medium">{Math.floor(Math.random() * 20) + 75}%</span>
                    </div>
                    <div>
                      <span className="text-gray-600 dark:text-gray-400">Last Active:</span>
                      <span className="ml-2 font-medium">{Math.floor(Math.random() * 3) + 1}h ago</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              <button className="w-full text-left p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                <p className="font-medium text-blue-900 dark:text-blue-100">Generate Reports</p>
                <p className="text-sm text-blue-700 dark:text-blue-200">Create institutional reports</p>
              </button>
              <button className="w-full text-left p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
                <p className="font-medium text-green-900 dark:text-green-100">Resource Allocation</p>
                <p className="text-sm text-green-700 dark:text-green-200">Manage therapist assignments</p>
              </button>
              <button className="w-full text-left p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors">
                ...
                <p className="text-sm text-purple-700 dark:text-purple-200">Configure platform settings</p>
              </button>
            </div>
          </div>
        </SlideUp>
        ...
        <SlideUp>
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Treatment Success Rate</span>
                <span className="font-medium">78%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Average Treatment Duration</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                <p className="font-medium text-red-900 dark:text-red-100">High Risk Patients</p>
                <p className="text-sm text-red-700 dark:text-red-200">3 patients require immediate attention</p>
              </div>
              <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <p className="font-medium text-yellow-900 dark:text-yellow-100">Compliance Review</p>
                <p className="text-sm text-yellow-700 dark:text-yellow-200">Quarterly audit due in 2 weeks</p>
              </div>
              <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="font-medium text-blue-900 dark:text-blue-100">System Update</p>
                <p className="text-sm text-blue-700 dark:text-blue-200">New features available</p>
              </div>
            </div>
          </div>
        </SlideUp>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {therapists.map((therapist) => (
            <div key={therapist.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
              <div className="flex items-center gap-4">
                <input
                  type="checkbox"
                  checked={selectedTherapists.includes(therapist.id)}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Therapist Utilization</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Patient Capacity</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">AI System Usage</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={dept.name} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className={`font-medium ${health.apiResponseTime < 50 ? 'text-green-600' : health.apiResponseTime < 100 ? 'text-yellow-600' : 'text-red-600'}`}>
                {health.apiResponseTime}ms
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Database Performance</span>
              <span className={`font-medium ${health.databasePerformance > 90 ? 'text-green-600' : health.databasePerformance > 80 ? 'text-yellow-600' : 'text-red-600'}`}>
                {health.databasePerformance}%
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Memory Usage</span>
              <span className={`font-medium ${health.memoryUsage < 70 ? 'text-green-600' : health.memoryUsage < 85 ? 'text-yellow-600' : 'text-red-600'}`}>
                {health.memoryUsage}%
              </span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Error Rate</span>
              <span className={`font-medium ${health.errorRate < 0.01 ? 'text-green-600' : health.errorRate < 0.05 ? 'text-yellow-600' : 'text-red-600'}`}>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
              <span className="font-medium text-green-900 dark:text-green-100">Platform Uptime</span>
              <span className="font-bold text-green-600">{health.uptime}%</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <span className="font-medium text-blue-900 dark:text-blue-100">Active Sessions</span>
              <span className="font-bold text-blue-600">{Math.floor(Math.random() * 50) + 20}</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              <span className="font-medium text-purple-900 dark:text-purple-100">Data Processing</span>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">HIPAA Compliance</span>
              <span className={`font-medium ${metrics.complianceScore >= 95 ? 'text-green-600' : 'text-yellow-600'}`}>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600 dark:text-gray-400">Access Controls</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            {[
              { type: 'Security Audit', date: '2024-01-15', status: 'passed', score: 96 },
              { type: 'HIPAA Compliance', date: '2024-01-10', status: 'passed', score: 94 },
              { type: 'Data Privacy', date: '2024-01-05', status: 'passed', score: 98 },
            ].map((audit, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">{audit.type}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{audit.date}</p>
                </div>
                <div className="text-right">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    audit.status === 'passed' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200'
                  }`}>
                    {audit.status}
                  </span>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{audit.score}%</p>
                </div>
              </div>
            ))}
          </div>
