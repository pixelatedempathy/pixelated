...
export const TabSyncDemo: FC = () => {
  ...
  const [counter, setCounter, counterLoaded, counterSyncStatus] = useSyncedState<number>({
  ...
  const [preferences, setPreferences, updatePreference, , prefsLoaded, prefsSyncStatus] = useSyncedObject<SyncedPreferences>({
  ...
  // Tab sync statistics
  const [syncStats, setSyncStats] = React.useState(() => tabSyncManager.getStats())
      ...
      <div className="space-y-8 p-8">
        ...
        <FadeIn>
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold mb-4">Synchronization Status</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  <div className={`w-3 h-3 rounded-full ${tabSyncManager.isAvailable() ? 'bg-green-500' : 'bg-red-500'}`} />
        ...
        {isLoaded && (
          <>
                ...
                <div className="max-w-md mx-auto space-y-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500 mb-4">
                      Sync Status: <span className={`font-medium ${
                        counterSyncStatus === 'synced' ? 'text-green-600' :
                        counterSyncStatus === 'syncing' ? 'text-yellow-600' :
                        counterSyncStatus === 'conflict' ? 'text-red-600' :
                        'text-gray-600'
                      }`}>
                        {counterSyncStatus}
                      </span>
            ...
            <FadeIn>
              <section className="space-y-6">
                <h2 className="text-2xl font-semibold mb-4">Synced Preferences</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="text-sm">
                          <span className="font-medium">Font Size:</span> {preferences.fontSize}
                        </div>
                        <div className="text-sm">
                          <span className="font-medium">Language:</span> {preferences.language}
                        </div>
                        <div className="text-sm">
                          <span className="font-medium">Notifications:</span> {preferences.notifications ? 'On' : 'Off'}
                        </div>
                      </div>

                      <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <div className="text-xs text-gray-500 mb-2">Sync Status:</div>
                        <div className={`text-sm font-medium ${
                          prefsSyncStatus === 'synced' ? 'text-green-600' :
                          prefsSyncStatus === 'syncing' ? 'text-yellow-600' :
                          prefsSyncStatus === 'conflict' ? 'text-red-600' :
                          'text-gray-600'
                        }`}>
                          {prefsSyncStatus}
                        </div>
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <h3 className="font-medium text-blue-900 dark:text-blue-100 mb-3">How It Works</h3>
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                    <h3 className="font-medium text-green-900 dark:text-green-100 mb-3">Features</h3>
            ...
            <FadeIn>
              <section className="space-y-4">
                ...
                <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  <h3 className="font-medium text-yellow-900 dark:text-yellow-100 mb-3">To test synchronization:</h3>
                  <ol className="text-sm text-yellow-700 dark:text-yellow-200 space-y-2 list-decimal list-inside">
                    <li>Open this page in a new tab (right-click → Open in new tab)</li>
                    <li>Make changes in one tab (counter or preferences)</li>
                    <li>Watch the changes appear instantly in the other tab</li>
                    <li>Try making conflicting changes to see resolution in action</li>
